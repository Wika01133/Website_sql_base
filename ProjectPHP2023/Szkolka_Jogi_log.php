...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section bg-light" id="zapisy">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Witaj</h2>
                    <h3 class="section-subheading text-muted">Zapisz się na zajęcia</h3>
                </div>
				
	        <?php
        include_once('klasy/Rezerwacja.php');
        include_once('klasy/Rezerwacja_Form.php');
        include_once ('klasy/Baza_rezerwacja.php');
        $rf = new Rezerwacja_Form(); //wyświetla formularz rejestracji
        $db = new Baza("localhost", "root", "", "klienci");
        if (filter_input(INPUT_POST, 'submit',
                        FILTER_SANITIZE_FULL_SPECIAL_CHARS)) {
            $rezerwacja = $rf->checkRezerwacja(); //sprawdza poprawność danych
            if ($rezerwacja === NULL){
